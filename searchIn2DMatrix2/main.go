...
/*
   ...
   we could have 2 types of matrix
   1. wide ( n > m )
   2. narrow ( m > n )
   if we start from bottom left corner, and worst case result is on top right corner
   - then we would take ~m+n steps to get there ( regardless of the type - draw both matrixes to see it )
